...
var AddProductComponent = /** @class */ (function () {
    ...
    AddProductComponent.prototype.addMore = function () {
        alert(this.moreData.productColor);
        if (this.productSize.length == 0) {
            this.sizeVali = "*Please select size.";
        }
        else if (this.trialImage.length == 0) {
            ...
            this.colorVali = '';
            this.addProductDetail.push({ "productPrice": parseInt(this.moreData.productPrice), "productColor": this.addProductForm.value.color, "productSize": this.productSize, "productImage": this.trialImage });
            //console.log("Saveproduct===>>"+JSON.stringify(this.addProductDetail))
    ...
    AddProductComponent.prototype.removeImage = function (ind) {
