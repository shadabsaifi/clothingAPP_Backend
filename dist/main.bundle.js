...
var AddProductComponent = /** @class */ (function () {
    function AddProductComponent(router, formBuilder) {
        this.router = router;
        this.formBuilder = formBuilder;
    }
    AddProductComponent.prototype.ngOnInit = function () {
        this.addProductForm = this.formBuilder.group({
            productName: ['', __WEBPACK_IMPORTED_MODULE_2__angular_forms__["e" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_2__angular_forms__["e" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["e" /* Validators */].pattern(/^[a-zA-Z ]*$/), __WEBPACK_IMPORTED_MODULE_2__angular_forms__["e" /* Validators */].minLength(2)])],
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__add_user_add_user_component__ = __webpack_require__("./src/app/add-user/add-user.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__brand_management_brand_management_component__ = __webpack_require__("./src/app/brand-management/brand-management.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__product_management_product_management_component__ = __webpack_require__("./src/app/product-management/product-management.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__add_product_add_product_component__ = __webpack_require__("./src/app/add-product/add-product.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__style_management_style_management_component__ = __webpack_require__("./src/app/style-management/style-management.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__view_user_view_user_component__ = __webpack_require__("./src/app/view-user/view-user.component.ts");
...
var routes = [
    ...
    { path: 'add-user', component: __WEBPACK_IMPORTED_MODULE_6__add_user_add_user_component__["a" /* AddUserComponent */] },
    { path: 'brand-management', component: __WEBPACK_IMPORTED_MODULE_7__brand_management_brand_management_component__["a" /* BrandManagementComponent */] },
    { path: 'product-management', component: __WEBPACK_IMPORTED_MODULE_8__product_management_product_management_component__["a" /* ProductManagementComponent */] },
    { path: 'add-product', component: __WEBPACK_IMPORTED_MODULE_9__add_product_add_product_component__["a" /* AddProductComponent */] },
    { path: 'style-management', component: __WEBPACK_IMPORTED_MODULE_10__style_management_style_management_component__["a" /* StyleManagementComponent */] },
    { path: 'view-user', component: __WEBPACK_IMPORTED_MODULE_11__view_user_view_user_component__["a" /* ViewUserComponent */] },
    { path: 'edit-user', component: __WEBPACK_IMPORTED_MODULE_12__edit_user_edit_user_component__["a" /* EditUserComponent */] }
];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__side_menu_side_menu_component__ = __webpack_require__("./src/app/side-menu/side-menu.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__user_management_user_management_component__ = __webpack_require__("./src/app/user-management/user-management.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__add_user_add_user_component__ = __webpack_require__("./src/app/add-user/add-user.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__brand_management_brand_management_component__ = __webpack_require__("./src/app/brand-management/brand-management.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__product_management_product_management_component__ = __webpack_require__("./src/app/product-management/product-management.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__style_management_style_management_component__ = __webpack_require__("./src/app/style-management/style-management.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__view_user_view_user_component__ = __webpack_require__("./src/app/view-user/view-user.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__edit_user_edit_user_component__ = __webpack_require__("./src/app/edit-user/edit-user.component.ts");
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_12__add_user_add_user_component__["a" /* AddUserComponent */],
                __WEBPACK_IMPORTED_MODULE_13__brand_management_brand_management_component__["a" /* BrandManagementComponent */],
                __WEBPACK_IMPORTED_MODULE_14__product_management_product_management_component__["a" /* ProductManagementComponent */],
                __WEBPACK_IMPORTED_MODULE_15__add_product_add_product_component__["a" /* AddProductComponent */],
                __WEBPACK_IMPORTED_MODULE_16__style_management_style_management_component__["a" /* StyleManagementComponent */],
                __WEBPACK_IMPORTED_MODULE_17__view_user_view_user_component__["a" /* ViewUserComponent */],
                __WEBPACK_IMPORTED_MODULE_18__edit_user_edit_user_component__["a" /* EditUserComponent */]
            ],
            imports: [
